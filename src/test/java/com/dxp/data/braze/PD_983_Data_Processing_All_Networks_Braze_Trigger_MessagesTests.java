...
public class PD_983_Data_Processing_All_Networks_Braze_Trigger_MessagesTests {
    protected static final Logger logger = LoggerFactory.getLogger(PD_983_Data_Processing_All_Networks_Braze_Trigger_MessagesTests.class);
   ...
   public static final String CAMPAIGN_IDENTIFIER = UUID.randomUUID().toString();
    ...
    public void setupData() {
        ...
        requestUriBraze = ConfigUtils.getProperty(ConfigUtils.ConfigKeys.BASE_URL_BRAZE.toString()) +
                              ConfigUtils.getProperty(ConfigUtils.ConfigKeys.END_URL_BRAZE_MESSAGES.toString());
        proxy = ConfigUtils.getProperty(ConfigUtils.ConfigKeys.PROXY_QA.toString());
    }

    @Test
    public void postBrazePositiveTest() {
       logger.info("Braze API call creates new message: ");
        ...
        logger.info("requestUriBraze: " + " " + requestUriBraze, "proxy:" + "" +proxy);
