...
public class PD_916_POST_SigmaDummyReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaDummyReportNegativeTest.class);
    ...
    private String requestUriDummy;
    ...
    public void setupData() {
        ...
        requestUriDummy = ConfigUtils.getProperty(ConfigUtils.ConfigKeys.BASE_URL_SIGMA.toString()) +
                     ConfigUtils.getProperty(ConfigUtils.ConfigKeys.END_URL_SIGMA_DUMMY.toString());

        proxy = ConfigUtils.getProperty(ConfigUtils.ConfigKeys.PROXY_QA.toString());
    }

    @Test
    public void postSigmaDummyReportNegativeTest() {

        Map<String, String> headers = RestAssuredConnector.setHeaders();
        Response reportResponse = connector.postRequest(requestUriDummy, proxy, headers, requestBody);
        logger.info("requestUri: " + " " + requestUriDummy);
