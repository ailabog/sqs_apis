...
public class PD_916_POST_SigmaInvalidUrlReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaInvalidUrlReportNegativeTest.class);
    ...
    public static final  String WEBHOOK_DATA_OBJECT_FILE_URL = "google.com";
    ...
    @Test
    public void postSigmaInvalidUrlNegativeTest() {
