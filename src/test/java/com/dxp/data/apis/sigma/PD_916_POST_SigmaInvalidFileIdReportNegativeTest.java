...
public class PD_916_POST_SigmaInvalidFileIdReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaInvalidFileIdReportNegativeTest.class);

    public static final String WEBHOOK_EVENT = "event";
    private Integer WEBHOOK_PENDING_EVENT_WEBHOOKS = 2;
    ...
    public static final  String WEBHOOK_DATA_OBJECT_FILE_ID = "sdgssgdgsd";
    public static final  String WEBHOOK_DATA_OBJECT_FILE_OBJECT = "file";
    public static final  String WEBHOOK_DATA_OBJECT_FILE_URL = "https://files.stripe.com/v1/files/sdgssgdgsd/contents";
    ...
    @Test
    public void postSigmaInvalidFieldReportNegativeTest() {
