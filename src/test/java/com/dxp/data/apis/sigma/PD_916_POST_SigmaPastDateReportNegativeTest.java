...
public class PD_916_POST_SigmaPastDateReportNegativeTest {

    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaPastDateReportNegativeTest.class);
    ...
    @Test
    public void postSigmaPastDateReportNegativeTest() {
        ...
        logger.info("requestUri: " + " " + requestUriMonthly, "proxy: " + "" + proxy);
