...
public class PD_916_POST_SigmaXmlReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaXmlReportNegativeTest.class);
    ...
    public static final String WEBHOOK_DATA_OBJECT_FILE_TYPE_XML = "xml";
    ...
    public void setupData() {
        ...
        requestSigmaMessageBody.setWebhook_data_object_file_type(WEBHOOK_DATA_OBJECT_FILE_TYPE_XML);
    ...
    @Test
    public void postSigmaReportXmlNegativeTest() {
