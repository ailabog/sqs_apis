...
public class PD_916_POST_SigmaDummyWebhookReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaDummyWebhookReportNegativeTest.class);
    ...
    @Test
    public void postSigmaDummyWebhookNegativeTest() {
