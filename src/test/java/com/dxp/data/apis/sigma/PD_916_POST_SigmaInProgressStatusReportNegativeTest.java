...
public class PD_916_POST_SigmaInProgressStatusReportNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(PD_916_POST_SigmaInProgressStatusReportNegativeTest.class);
    ...
    public static final String WEBHOOK_DATA_OBJECT_STATUS = "in progress";
    ...
    @Test
    public void postSigmaInProgressStatusNegativeTest() {
